...
namespace WebApplication4
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            SqlConnection sqlConnection1 = new SqlConnection(@"Data Source = rnrtestserver.database.windows.net; Initial Catalog = AMDSupportingDB_PROD;Connection Timeout=9000;
            User ID = rnrAdmin; Password = India@123");
            SqlCommand cmd = new SqlCommand();
            DataTable dt = new DataTable();
            cmd.CommandText = "show_msg";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@StartDate", "2017-09-20");
            cmd.Parameters.AddWithValue("@EndDate", "2017-11-15");
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                string market = row.Cells[2].Text;
                dt.Rows.Add(date, viewname,market);
        ...
        public void SendMail(string htmlString)
        {
            try
            {
                ...
                string fromPassword = "nem!@#$1234";
                string[] ToMailIds = new string[] { "v-robelw@microsoft.com" };
        ...
        public static string getHtml(DataSet dataSet)
        {
            try
            {
                ...
                messageBody += htmlTdStart + "market " + htmlTdEnd;
                ...
                foreach (DataRow Row in dataSet.Tables[0].Rows)
                {
                    ...
                    messageBody = messageBody + htmlTdStart + Row["market"] + htmlTdEnd;
